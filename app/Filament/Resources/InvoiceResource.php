    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Section::make(__('app.invoice.items'))
                ...
                ->schema([
                    // The till field. A USB scanner types the barcode and sends
                    // Enter, so the line has to be added without a single click.
                    Forms\Components\TextInput::make('scan')
                        ->label(__('app.scan.label'))
                        ->helperText(__('app.scan.aide'))
                        ...
                        ->extraInputAttributes([
                            'enterkeyhint' => 'done',
                            // Enter in this field must not submit the whole sale.
                        ...
                        ->afterStateUpdated(function ($state, Set $set, Get $get) {
                            ...
                            // Always clear: the next scan must land in an empty
                            // box, hit or miss.
                            $set('scan', '');
                            ...
                            $result = ScanCart::add(
                                ScanCart::withoutBlankRows((array) $get('items')),
                                $code,
                                $article
                            );
                            ...
                            // Selling into negative stock is legitimate here (loose
                            // weight, a delivery not yet keyed in), so warn and let
                            // the sale through rather than blocking the counter.
